...
function ccvalidator () {
 ...
 function addSlash (e) {
    var isMonthEntered = app.monthRegex.exec(e);
    if (e >= 0 && e <= 9 && isMonthEntered) {
      e = e + ' / ';
    }
  };

   function removeSlash (e) {
    var isMonthAndSlashEntered = app.monthAndSlashRegex.exec(e);
    if (isMonthAndSlashEntered && e === 'Backspace') {
      e = e.slice(0, -3);
    }
  };
